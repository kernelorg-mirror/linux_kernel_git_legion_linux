		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	rc = sysctl_write_intvec_data(&timer_active, ctx->ctl_table,
			buffer, lenp, ppos,
			sysctl_conv_intvec,
			SYSCTL_ZERO,
			SYSCTL_ONE);
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return sysctl_read_intvec_data(&timer_active, ctx->ctl_table,
			buffer, lenp, ppos,
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	rc = sysctl_write_intvec_data(&interval, ctx->ctl_table,
			buffer, lenp, ppos,
			sysctl_conv_intvec,
			SYSCTL_ONE,
			NULL);
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return sysctl_read_intvec_data(&interval, ctx->ctl_table,
			buffer, lenp, ppos,
			sysctl_conv_intvec, NULL, NULL);
}
		      ...
		      char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	rc = sysctl_read_intvec_data(&active, ctx->ctl_table,
			buffer, lenp, ppos,
			sysctl_conv_intvec, NULL, NULL);
		       ...
		       char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	rc = sysctl_write_intvec_data(&active, ctx->ctl_table,
			buffer, lenp, ppos,
