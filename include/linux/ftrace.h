...
extern int
ftrace_enable_sysctl(struct ctl_context *ctx,
...
int stack_trace_sysctl(struct ctl_context *ctx, void *buffer,
...
int tracepoint_printk_sysctl(struct ctl_context *ctx,
			     void *buffer, size_t *lenp, loff_t *ppos);
