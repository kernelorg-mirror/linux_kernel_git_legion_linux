...
/* this is needed for the sysctl_write_intvec for [fs_]overflow UID and GID */
...
struct ctl_fops {
	...
	void *(*get_data) (struct ctl_context *ctx, struct file *file);
...
extern struct ctl_fops max_threads_fops;
