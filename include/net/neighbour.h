...
int neigh_proc_dointvec(struct ctl_context *ctx, struct ctl_table *ctl, int write,
			void *buffer, size_t *lenp, loff_t *ppos);
int neigh_proc_dointvec_jiffies(struct ctl_context *ctx, struct ctl_table *ctl,
				int write, void *buffer,
				size_t *lenp, loff_t *ppos);
int neigh_proc_dointvec_ms_jiffies(struct ctl_context *ctx, struct ctl_table *ctl,
