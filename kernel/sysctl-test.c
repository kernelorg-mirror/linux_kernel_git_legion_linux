...
static void sysctl_test_api_dointvec_null_tbl_data(struct kunit *test)
{
	 ...
	 */
	len = 1234;
	KUNIT_EXPECT_EQ(test, 0, do_proc_dointvec_r(null_data_table.data,
						    &null_data_table,
						    buffer, &len, &pos,
	 ...
	 */
	len = 1234;
	KUNIT_EXPECT_EQ(test, 0, do_proc_dointvec_w(null_data_table.data,
						    &null_data_table,
						    buffer, &len, &pos,
						    do_proc_dointvec_minmax_conv,
						    NULL, NULL));
...
static void sysctl_test_api_dointvec_table_maxlen_unset(struct kunit *test)
{
	 ...
	 */
	len = 1234;
	KUNIT_EXPECT_EQ(test, 0, do_proc_dointvec_r(data_maxlen_unset_table.data,
	 ...
	 */
	len = 1234;
	KUNIT_EXPECT_EQ(test, 0, do_proc_dointvec_w(data_maxlen_unset_table.data,
						    &data_maxlen_unset_table,
						    buffer, &len, &pos,
						    do_proc_dointvec_minmax_conv,
						    NULL, NULL));
...
static void sysctl_test_api_dointvec_table_len_is_zero(struct kunit *test)
{
	...
	KUNIT_EXPECT_EQ(test, 0, do_proc_dointvec_r(table.data,
						    &table,
						    buffer, &len, &pos,
						    do_proc_dointvec_minmax_conv,
						    NULL, NULL));
	...
	KUNIT_EXPECT_EQ(test, 0, do_proc_dointvec_w(table.data,
						    &table,
						    buffer, &len, &pos,
						    do_proc_dointvec_minmax_conv,
						    NULL, NULL));
		...
		struct kunit *test)
{
	...
	KUNIT_EXPECT_EQ(test, -EINVAL, do_proc_dointvec_w(table.data,
						    &table,
						    user_buffer, &len, &pos,
						    do_proc_dointvec_minmax_conv,
						    NULL, NULL));
