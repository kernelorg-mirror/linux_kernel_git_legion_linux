...
static unsigned long *name ## _data(const struct ctl_context *ctx)	\
{									\
...
UCOUNT_DATA(fanotify_masks, UCOUNT_FANOTIFY_MARKS);
#endif

static const struct ctl_field user_table[] = {
	CTL_FIELD_STATIC_ULONG_MINMAX("max_user_namespaces", 0644, user_ns_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_pid_namespaces", 0644, pid_ns_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_uts_namespaces", 0644, uts_ns_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_ipc_namespaces", 0644, ipc_ns_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_net_namespaces", 0644, net_ns_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_mnt_namespaces", 0644, mnt_ns_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_cgroup_namespaces", 0644, cgroup_ns_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_time_namespaces", 0644, time_ns_data, &ue_zero, &ue_int_max),
#ifdef CONFIG_INOTIFY_USER
	CTL_FIELD_STATIC_ULONG_MINMAX("max_inotify_instances", 0644, inotify_instances_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_inotify_watches", 0644, inotify_watches_data, &ue_zero, &ue_int_max),
#endif
#ifdef CONFIG_FANOTIFY
	CTL_FIELD_STATIC_ULONG_MINMAX("max_fanotify_groups", 0644, fanotify_groups_data, &ue_zero, &ue_int_max),
	CTL_FIELD_STATIC_ULONG_MINMAX("max_fanotify_masks", 0644, fanotify_masks_data, &ue_zero, &ue_int_max),
#endif
};
#endif /* CONFIG_SYSCTL */
...
bool setup_userns_sysctls(struct user_namespace *ns)
{
	...
	ns->sysctls = __register_sysctl_fields(&ns->set, "user",
					       user_table, ARRAY_SIZE(user_table),
					       &ctx);
	if (!ns->sysctls) {
