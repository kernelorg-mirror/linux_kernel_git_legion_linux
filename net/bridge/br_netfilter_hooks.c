...
static void *brnf_ ## field ## _data(const struct ctl_context *ctx)	\
{									\
...
static const struct ctl_field brnf_table[] = {
	CTL_FIELD_CUSTOM("bridge-nf-call-arptables", 0644, sizeof(int),
			 brnf_call_arptables_data, brnf_sysctl_call_tables),
	CTL_FIELD_CUSTOM("bridge-nf-call-iptables", 0644, sizeof(int),
			 brnf_call_iptables_data, brnf_sysctl_call_tables),
	CTL_FIELD_CUSTOM("bridge-nf-call-ip6tables", 0644, sizeof(int),
			 brnf_call_ip6tables_data, brnf_sysctl_call_tables),
	CTL_FIELD_CUSTOM("bridge-nf-filter-vlan-tagged", 0644, sizeof(int),
			 brnf_filter_vlan_tagged_data,
			 brnf_sysctl_call_tables),
	CTL_FIELD_CUSTOM("bridge-nf-filter-pppoe-tagged", 0644, sizeof(int),
			 brnf_filter_pppoe_tagged_data,
			 brnf_sysctl_call_tables),
	CTL_FIELD_CUSTOM("bridge-nf-pass-vlan-input-dev", 0644, sizeof(int),
...
static int br_netfilter_sysctl_init_net(struct net *net)
{
	...
	brnet->ctl_hdr = register_net_sysctl_fields_sz(net, "net/bridge",
						       brnf_table,
