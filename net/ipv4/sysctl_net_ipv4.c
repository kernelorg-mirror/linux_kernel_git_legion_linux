		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	ret = do_proc_dointvec_w(&range, ctx->ctl_table, buffer, lenp, ppos,
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_r(&range, ctx->ctl_table, buffer, lenp, ppos,
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	ret = do_proc_dointvec_w(&pports, ctx->ctl_table, buffer, lenp, ppos,
			do_proc_dointvec_minmax_conv,
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_r(&net->ipv4.sysctl_ip_prot_sock, ctx->ctl_table,
			buffer, lenp, ppos,
			do_proc_dointvec_minmax_conv, NULL, NULL);
}
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	ret = do_proc_dointvec_w(&urange, ctx->ctl_table, buffer, lenp, ppos,
			do_proc_dointvec_minmax_conv,
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_r(&urange, ctx->ctl_table, buffer, lenp, ppos,
			do_proc_dointvec_minmax_conv, NULL, NULL);
}
