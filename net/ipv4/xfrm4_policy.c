...
#ifdef CONFIG_SYSCTL
static int *xfrm4_gc_thresh_data(const struct ctl_context *ctx)
{
	return &ctx->ns.net_ns->xfrm.xfrm4_dst_ops.gc_thresh;
}

static const struct ctl_field xfrm4_policy_table[] = {
	CTL_FIELD_INT("xfrm4_gc_thresh", 0644, xfrm4_gc_thresh_data),
};
...
static __net_init int xfrm4_net_sysctl_init(struct net *net)
{
	...
	hdr = register_net_sysctl_fields_sz(net, "net/ipv4", xfrm4_policy_table,
