		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	 ...
	 */
	ret = do_proc_dointvec_w(&val, ctx->ctl_table, buffer, lenp, ppos,
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	ret = do_proc_dointvec_w(&new, ctx->ctl_table, buffer, lenp, ppos,
			do_proc_dointvec_minmax_conv, NULL, NULL);
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	ret = do_proc_douintvec_w(&new_val, ctx->ctl_table,
			buffer, lenp, ppos,
		...
		char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	ret = proc_douintvec_minmax_r(ctx, file, buffer, lenp, ppos);
