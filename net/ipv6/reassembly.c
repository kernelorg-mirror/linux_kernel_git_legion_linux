...
static unsigned long *ip6_frags_high_thresh_data(const struct ctl_context *ctx)
{
	return &ctx->ns.net_ns->ipv6.fqdir->high_thresh;
}

static unsigned long *ip6_frags_low_thresh_data(const struct ctl_context *ctx)
{
	return &ctx->ns.net_ns->ipv6.fqdir->low_thresh;
}

static void *ip6_frags_timeout_data(const struct ctl_context *ctx)
{
	return &ctx->ns.net_ns->ipv6.fqdir->timeout;
}

static const struct ctl_field ip6_frags_ns_ctl_table[] = {
	CTL_FIELD_ULONG_MINMAX("ip6frag_high_thresh", 0644,
			       ip6_frags_high_thresh_data,
			       ip6_frags_low_thresh_data, NULL),
	CTL_FIELD_ULONG_MINMAX("ip6frag_low_thresh", 0644,
			       ip6_frags_low_thresh_data,
			       NULL, ip6_frags_high_thresh_data),
	CTL_FIELD_CUSTOM("ip6frag_time", 0644, sizeof(int),
...
static int __net_init ip6_frags_ns_sysctl_register(struct net *net)
{
	...
	hdr = register_net_sysctl_fields_sz(net, "net/ipv6",
