...
static void *ip6_frag_high_thresh_data(const struct ctl_context *ctx)
{
	return &ctx->ns.net_ns->ipv6.fqdir->high_thresh;
}

static void *ip6_frag_low_thresh_data(const struct ctl_context *ctx)
{
	return &ctx->ns.net_ns->ipv6.fqdir->low_thresh;
}

static void *ip6_frag_timeout_data(const struct ctl_context *ctx)
{
...
static const struct ctl_field ip6_frags_ns_ctl_table[] = {
	{
		...
		.data   = ip6_frag_high_thresh_data,
		.extra1 = ip6_frag_low_thresh_data,
	},
	{
		.table = {
		...
		.data   = ip6_frag_low_thresh_data,
		.extra2 = ip6_frag_high_thresh_data,
	},
	{
		.table = {
...
static int __net_init ip6_frags_ns_sysctl_register(struct net *net)
{
	...
	hdr = register_net_sysctl_fields(net, "net/ipv6",
