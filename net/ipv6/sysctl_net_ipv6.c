...
static type *ipv6_##name##_data(const struct ctl_context *ctx)		\
{									\
...
static const struct ctl_field ipv6_table[] = {
	CTL_FIELD_U8("bindv6only", 0644, ipv6_bindv6only_data),
	CTL_FIELD_U8("anycast_src_echo_reply", 0644,
		     ipv6_anycast_src_echo_reply_data),
	CTL_FIELD_U8("flowlabel_consistency", 0644,
		     ipv6_flowlabel_consistency_data),
	CTL_FIELD_STATIC_U8_MINMAX("auto_flowlabels", 0644,
				   ipv6_auto_flowlabels_data, NULL,
				   &auto_flowlabels_max),
	CTL_FIELD_U8("fwmark_reflect", 0644, ipv6_fwmark_reflect_data),
	CTL_FIELD_INT("idgen_retries", 0644, ipv6_idgen_retries_data),
	CTL_FIELD_CUSTOM("idgen_delay", 0644, sizeof(int),
			 ipv6_idgen_delay_data, proc_dointvec_jiffies),
	CTL_FIELD_U8("flowlabel_state_ranges", 0644,
		     ipv6_flowlabel_state_ranges_data),
	CTL_FIELD_U8("ip_nonlocal_bind", 0644, ipv6_ip_nonlocal_bind_data),
	CTL_FIELD_STATIC_INT_MINMAX("flowlabel_reflect", 0644,
				    ipv6_flowlabel_reflect_data,
				    SYSCTL_ZERO, &flowlabel_reflect_max),
	CTL_FIELD_INT("max_dst_opts_number", 0644,
		      ipv6_max_dst_opts_number_data),
	CTL_FIELD_INT("max_hbh_opts_number", 0644,
		      ipv6_max_hbh_opts_number_data),
	CTL_FIELD_INT("max_dst_opts_length", 0644,
		      ipv6_max_dst_opts_length_data),
	CTL_FIELD_INT("max_hbh_length", 0644, ipv6_max_hbh_length_data),
	CTL_FIELD_CUSTOM("fib_multipath_hash_policy", 0644, sizeof(u8),
			 ipv6_fib_multipath_hash_policy_data,
			 proc_rt6_multipath_hash_policy),
	CTL_FIELD_CUSTOM("fib_multipath_hash_fields", 0644, sizeof(u32),
			 ipv6_fib_multipath_hash_fields_data,
			 proc_rt6_multipath_hash_fields),
	CTL_FIELD_INT("seg6_flowlabel", 0644, ipv6_seg6_flowlabel_data),
	...
	CTL_FIELD_STATIC_UINT_MINMAX("ioam6_id", 0644, ipv6_ioam6_id_data,
				     NULL, &ioam6_id_max),
	CTL_FIELD_CUSTOM("ioam6_id_wide", 0644, sizeof(u64),
...
static int __net_init ipv6_sysctl_net_init(struct net *net)
{
	...
	net->ipv6.sysctl.hdr = register_net_sysctl_fields_sz(net, "net/ipv6",
							     ipv6_table,
							     ARRAY_SIZE(ipv6_table));
	if (!net->ipv6.sysctl.hdr)
		goto out;

	net->ipv6.sysctl.route_hdr = register_net_sysctl_fields_sz(net, "net/ipv6/route",
								   ipv6_route_sysctl_table(),
								   ipv6_route_sysctl_table_size(net));
	if (!net->ipv6.sysctl.route_hdr)
		goto out_unregister_ipv6_table;

	net->ipv6.sysctl.icmp_hdr = register_net_sysctl_fields_sz(net, "net/ipv6/icmp",
								  ipv6_icmp_sysctl_table(),
