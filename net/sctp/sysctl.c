		...
		struct file *file, char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_w(&net->sctp.rto_min, ctx->ctl_table, buffer, lenp, ppos,
		...
		struct file *file, char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_r(&net->sctp.rto_min, ctx->ctl_table, buffer, lenp, ppos,
			do_proc_dointvec_minmax_conv,
			ctx->ctl_table->extra1,
			ctx->ctl_table->extra2);
}
		...
		struct file *file, char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_w(&net->sctp.rto_max, ctx->ctl_table, buffer, lenp, ppos,
			do_proc_dointvec_minmax_conv,
			ctx->ctl_table->extra1,
			ctx->ctl_table->extra2);
}
		...
		struct file *file, char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_r(&net->sctp.rto_max, ctx->ctl_table, buffer, lenp, ppos,
			do_proc_dointvec_minmax_conv,
			ctx->ctl_table->extra1,
			ctx->ctl_table->extra2);
}
		...
		struct file *file, char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_r(&net->sctp.auth_enable, ctx->ctl_table,
		...
		struct file *file, char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_r(&net->sctp.udp_port, ctx->ctl_table,
			buffer, lenp, ppos, do_proc_dointvec_minmax_conv, NULL, NULL);
}
		...
		struct file *file, char *buffer, size_t *lenp, loff_t *ppos)
{
	...
	return do_proc_dointvec_r(&net->sctp.probe_interval, ctx->ctl_table,
			buffer, lenp, ppos, do_proc_dointvec_minmax_conv, NULL, NULL);
}
